...
public class OrderManager {
    ...
    private HashMap<String, RestaurantOrder> hashMap;
    ...
    private void checkAddress(String address) throws OrderAlreadyAddedException {
    ...
    public void add(String address, RestaurantOrder order) throws OrderAlreadyAddedException {
